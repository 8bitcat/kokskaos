...
export const STR = {
  sv: {
    ...
    controls: [['WASD', 'gå'], ['Shift', 'spring'], ['Mellanslag', 'hoppa'], ['Ctrl / C', 'huka'], ['Vänster / höger musknapp', 'vänster / höger hand — håll in för att greppa'], ['Q / E', 'lås greppet (vänster / höger)'],
      ['Mushjul', 'dra närmare / skjut bort'], ['R + mus', 'vrid handleden (häll, vänd, tippa)'], ['T', 'räta upp'], ['F / mushjulsklick', 'kasta (håll in för kraft)'], ['1–9, 0', 'emotes (dansa, skaka rumpa …)'], ['Tab', 'kockens anteckningar (recept) · ← → bläddrar'], ['H', 'visa / göm hjälp'], ['M', 'ljud av / på'], ['Esc', 'meny']],
  ...
  en: {
    ...
    controls: [['WASD', 'move'], ['Shift', 'run'], ['Space', 'jump'], ['Ctrl / C', 'crouch'], ['Left / right mouse button', 'left / right hand — hold to grab'], ['Q / E', 'lock grip (left / right)'],
      ['Mouse wheel', 'pull closer / push away'], ['R + mouse', 'turn your wrist (pour, flip, tip)'], ['T', 'level out'], ['F / wheel click', 'throw (hold for power)'], ['1–9, 0', 'emotes (dance, butt shake …)'], ['Tab', "the chef's notes (recipes) · ← → flip"], ['H', 'show / hide help'], ['M', 'mute'], ['Esc', 'menu']],
