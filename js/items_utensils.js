...
export const UTENSILS = {
  wok: {
    n: ['Wok', 'Wok'], mass: 1.2, mat: 'metal', friction: 0.55,
  ...
  grillpan: {
    n: ['Grillpanna', 'Grill pan'], mass: 1.4, mat: 'metal', friction: 0.6,
  ...
  casserole: {
    n: ['Gjutjärnsgryta', 'Dutch oven'], mass: 2.4, mat: 'metal', friction: 0.55,
  ...
  ovendish: {
    n: ['Ugnsform', 'Oven dish'], mass: 1.2, friction: 0.8, sfx: 'clink',
  ...
  mixbowl: {
    n: ['Bunke', 'Mixing bowl'], mass: 0.6, mat: 'metal', friction: 0.6,
  ...
  colander: {
    n: ['Durkslag', 'Colander'], mass: 0.5, mat: 'metal', friction: 0.6,
  ...
  jug: {        // carry water from the tap to a pot on the hob
    n: ['Måttkanna', 'Measuring jug'], mass: 0.4, friction: 0.7, sfx: 'clink',
  ...
  mortar: {
    n: ['Mortel', 'Mortar'], mass: 1.3, friction: 0.9, sfx: 'wood',
  ...
  pestle: {
    n: ['Mortelstöt', 'Pestle'], mass: 0.35, friction: 0.9, sfx: 'wood',
  ...
  lid: {        // a lidded pot boils much faster
    n: ['Grytlock', 'Pot lid'], mass: 0.45, mat: 'metal', friction: 0.6,
  ...
  ladle: {      // a real little cup: scoop sauce and pour it over the pasta
    n: ['Slev', 'Ladle'], mass: 0.22, mat: 'metal', friction: 0.7,
  ...
  strainer: {   // long-handled spider: fish the fries out of the fryer
    n: ['Fritössil', 'Spider strainer'], mass: 0.25, mat: 'metal', friction: 0.8,
  ...
  skimmer: {
    n: ['Hålslev', 'Slotted spoon'], mass: 0.18, mat: 'metal', friction: 0.8,
  ...
  whisk: {
    n: ['Visp', 'Whisk'], mass: 0.12, mat: 'metal', friction: 0.6,
  ...
  tongs: {
    n: ['Tång', 'Tongs'], mass: 0.15, mat: 'metal', friction: 0.7,
  ...
  masher: {     // smash it down on boiled potatoes => mashed potato
    n: ['Potatisstöt', 'Potato masher'], mass: 0.3, mat: 'metal', friction: 0.7, tool: 'mash',
  ...
  peeler: {
    n: ['Potatisskalare', 'Peeler'], mass: 0.06, friction: 0.7,
  ...
  grater: {     // rub a block of cheese against it => grated cheese
    n: ['Rivjärn', 'Grater'], mass: 0.35, mat: 'metal', friction: 0.7, tool: 'grate',
  ...
  carvingfork: {
    n: ['Stekgaffel', 'Carving fork'], mass: 0.14, mat: 'metal', friction: 0.6,
  ...
  mallet: {     // whack a steak flat => schnitzel
    n: ['Köttklubba', 'Meat mallet'], mass: 0.7, mat: 'metal', friction: 0.7, tool: 'pound',
  ...
  rollingpin: { // roll/whack a dough ball flat => pizza base   (overrides the plain one)
    n: ['Kavel', 'Rolling pin'], mass: 0.6, friction: 0.7, sfx: 'wood', tool: 'roll',
  ...
  breadknife: {
    n: ['Brödkniv', 'Bread knife'], mass: 0.22, mat: 'metal', friction: 0.5, blade: 1,
  ...
  paringknife: {
    n: ['Skalkniv', 'Paring knife'], mass: 0.1, mat: 'metal', friction: 0.5, blade: 1,
  ...
  ketchup: {
    n: ['Ketchupflaska', 'Ketchup bottle'], mass: 0.3, friction: 0.8, squeeze: 'ketchupblob',
  ...
  mustard: {
    n: ['Senapsflaska', 'Mustard bottle'], mass: 0.3, friction: 0.8, squeeze: 'mustardblob',
    col: [cyl(0.075, 0.032, [0, 0.075, 0], null, 0.9), cyl(0.025, 0.012, [0, 0.175, 0], null, 0.1)],
  ...
  jam: {
    n: ['Syltflaska', 'Jam bottle'], mass: 0.3, friction: 0.8, squeeze: 'jamblob',
    col: [cyl(0.075, 0.032, [0, 0.075, 0], null, 0.9), cyl(0.025, 0.012, [0, 0.175, 0], null, 0.1)],
  ...
  battermix: {
    n: ['Pannkakssmet', 'Pancake batter'], mass: 0.4, friction: 0.8, squeeze: 'batterblob',
